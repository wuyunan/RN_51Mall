...
public class Md5 {
    ...
    public static String sign(String text, String key, String input_charset) {
        ...
        String mysign = null;
        try {
            mysign  = encodeByMd5(text,input_charset);
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @throws IOException Thrown if the digestifier was unable to read the input
     *                     stream.
     */
    ...
    public static String encodeByMd5(String s) throws Exception {
        return encodeByMd5(s, "UTF-8");
    }

    /**
     * encodeByMd5(这里用一句话描述这个方法的作用)
     *
     * @param s        MD5加密的字符串
     * @param encoding MD5的编码格式 例如"UTF-8"
     * @return
     * @throws Exception String
     * @throws
     */
    public static String encodeByMd5(String s, String encoding)
            throws Exception {
        String resultString = null;
        MessageDigest md = MessageDigest.getInstance("MD5");
        resultString = byteToString(md.digest(s.getBytes(encoding)));
        return resultString;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Md5 md5 = new Md5("");
        String pwd = md5.encodeByMd5("test");
